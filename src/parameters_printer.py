...
def print_parameters(objects_dict):
    '''
    Prints out the parameters for the search to a file called 'ga_parameters' inside the garun directory
    ...
    parameters_file = open(os.getcwd() + '/ga_parameters', 'w')
    ...
    for endpoint in composition_space.endpoints:
        parameters_file.write('    - ' + endpoint.reduced_formula.replace(' ', '') + '\n')
    parameters_file.write('\n')
    ...
    for variation in variations:
        ...
        if variation.fraction == 0:
            ...
            if variation.name == 'mating':
                ...
                parameters_file.write('        merge_cutoff: ' + str(variation.merge_sites) + '\n')
    ...
    parameters_file.write('    scale_density: ' + str(developer.scale_density) + '\n')
    parameters_file.write('\n')
