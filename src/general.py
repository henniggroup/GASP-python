...
2. Organism: represents an organism, which consists primarily of a structure and an energy
3. InitialPopulation: represents the initial population of organisms, produced from one or more of the organism creators
...
6. SelectionProbDist: specifies the distribution from which selection probabilities are drawn
...
class Organism(object):
    ...
    def __init__(self, structure, id_generator, maker):
        ...
        self._id = id_generator.make_id(); # unique id number for this organism. Should not be changed.
    ...
    def translate_atoms_into_cell(self):
        ...
        self.structure.translate_sites(site_indices, translation_vector, frac_coords = True, to_unit_cell = False)  
...
class InitialPopulation():
    ...
    def print_convex_hull_area(self, composition_space):
        ...
        if self.has_endpoints(composition_space) and self.has_non_endpoint(composition_space):
...
class Pool(object):
    ...
    def check_promotion_set_pd(self):
        ...
        Precondition: a pd search is being done, and all organisms in the pool have up-to-date values (set by calling compute_pd_values)
        '''
...
class OffspringGenerator(object):
    ...
    Basically a place for the make_offspring_organism method to live
    '''
    def __init__(self):
        pass
  
     
    def make_offspring_organism(self, random, pool, variations, geometry, id_generator, whole_pop, developer, redundancy_guard, composition_space, constraints):
        '''
        ...
        while True:
            ...
            while num_tries < max_num_tries:
                offspring = variation.do_variation(pool, random, geometry, id_generator)
                offspring = developer.develop(offspring, composition_space, constraints, geometry, pool)
